...
import com.diti5.gestionstock.repository.ProduitRepository;
...
public class ProduitResourceIT {
    ...
    public static Produit createEntity(EntityManager em) {
        Produit produit = new Produit()
            .libelle_produit(DEFAULT_LIBELLE_PRODUIT);
        return produit;
    }
    /**
    ...
    public static Produit createUpdatedEntity(EntityManager em) {
        Produit produit = new Produit()
            .libelle_produit(UPDATED_LIBELLE_PRODUIT);
        return produit;
    }
    ...
    public void createProduit() throws Exception {
        ...
        assertThat(testProduit.getLibelle_produit()).isEqualTo(DEFAULT_LIBELLE_PRODUIT);
    }
    ...
    public void getAllProduits() throws Exception {
        ...
        restProduitMockMvc.perform(get("/api/produits?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].libelle_produit").value(hasItem(DEFAULT_LIBELLE_PRODUIT)));
    }
    ...
    public void getProduit() throws Exception {
        ...
        restProduitMockMvc.perform(get("/api/produits/{id}", produit.getId()))
            ...
            .andExpect(jsonPath("$.libelle_produit").value(DEFAULT_LIBELLE_PRODUIT));
    }
    @Test
    @Transactional
    ...
    public void updateProduit() throws Exception {
        ...
        Produit testProduit = produitList.get(produitList.size() - 1);
        assertThat(testProduit.getLibelle_produit()).isEqualTo(UPDATED_LIBELLE_PRODUIT);
    }
