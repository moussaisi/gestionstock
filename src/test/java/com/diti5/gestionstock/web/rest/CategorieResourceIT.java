...
import com.diti5.gestionstock.repository.CategorieRepository;
...
public class CategorieResourceIT {
    ...
    private static final String DEFAULT_LIBELLE_CATEGORIE = "AAAAAAAAAA";
    private static final String UPDATED_LIBELLE_CATEGORIE = "BBBBBBBBBB";
    ...
    public static Categorie createEntity(EntityManager em) {
        Categorie categorie = new Categorie()
            .libelle_categorie(DEFAULT_LIBELLE_CATEGORIE);
        return categorie;
    }
    /**
    ...
    public static Categorie createUpdatedEntity(EntityManager em) {
        Categorie categorie = new Categorie()
            .libelle_categorie(UPDATED_LIBELLE_CATEGORIE);
        return categorie;
    }
    ...
    public void createCategorie() throws Exception {
        ...
        assertThat(testCategorie.getLibelle_categorie()).isEqualTo(DEFAULT_LIBELLE_CATEGORIE);
    }
    ...
    public void getAllCategories() throws Exception {
        ...
        restCategorieMockMvc.perform(get("/api/categories?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].libelle_categorie").value(hasItem(DEFAULT_LIBELLE_CATEGORIE)));
    }
    ...
    public void getCategorie() throws Exception {
        ...
        restCategorieMockMvc.perform(get("/api/categories/{id}", categorie.getId()))
            ...
            .andExpect(jsonPath("$.libelle_categorie").value(DEFAULT_LIBELLE_CATEGORIE));
    }
    @Test
    @Transactional
    ...
    public void updateCategorie() throws Exception {
        ...
        Categorie testCategorie = categorieList.get(categorieList.size() - 1);
        assertThat(testCategorie.getLibelle_categorie()).isEqualTo(UPDATED_LIBELLE_CATEGORIE);
    }
