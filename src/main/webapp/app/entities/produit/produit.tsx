          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('libelle_produit')}>
                  Libelle Produit <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {produitList.map((produit, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {produit.categorie ? <Link to={`categorie/${produit.categorie.id}`}>{produit.categorie.libelle_categorie}</Link> : ''}
                  </td>
