          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('prenom_client')}>
                  Prenom Client <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('nom_client')}>
                  Nom Client <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <tr key={`entity-${i}`}>
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${facture.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      >
